...
/** Persists layout prefs; bump key if INIT_STATE defaults change so users get fresh defaults. */
const LAYOUT_STORAGE_KEY = '__WPHUBPRO_LAYOUT_CONFIG_V2__'
...
const LayoutProvider = ({ children }: ChildrenType) => {
  const [settings, setSettings] = useLocalStorage<LayoutState>(LAYOUT_STORAGE_KEY, INIT_STATE)
