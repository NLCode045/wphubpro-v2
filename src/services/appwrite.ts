...
export const APPWRITE_FUNCTION_IDS = {
  ...
  STRIPE_PORTAL_LINK: envString('APPWRITE_FUNCTION_STRIPE_PORTAL_LINK', STRIPE_CONSUMER_FUNCTION_ID),
  STRIPE_PRODUCTS: envString('APPWRITE_FUNCTION_STRIPE_PRODUCTS', STRIPE_CONSUMER_FUNCTION_ID),
  STRIPE_ORDER_PAYMENTS: envString('APPWRITE_FUNCTION_STRIPE_ORDER_PAYMENTS', STRIPE_CONSUMER_FUNCTION_ID),
  STRIPE_SUBSCRIPTIONS: envString('APPWRITE_FUNCTION_STRIPE_SUBSCRIPTIONS', STRIPE_CONSUMER_FUNCTION_ID),
  STRIPE_INVOICES: envString('APPWRITE_FUNCTION_STRIPE_INVOICES', STRIPE_CONSUMER_FUNCTION_ID),
  STRIPE_PAYMENT_METHODS: envString('APPWRITE_FUNCTION_STRIPE_PAYMENT_METHODS', STRIPE_CONSUMER_FUNCTION_ID),
  STRIPE_CREATE_CUSTOMER: envString('APPWRITE_FUNCTION_STRIPE_CREATE_CUSTOMER', STRIPE_CONSUMER_FUNCTION_ID),
