...
/** Complete Appwrite password recovery from email link (`userId` + `secret` query params). */
const NewPasswordPage = () => {
  ...
  const canSubmit = userId.length > 0 && secret.length > 0
          ...
          <Col xxl={4} md={6} sm={8}>
            <Card className="p-4">
              ...
              <div className="auth-brand text-center mb-4">
                <AppLogo />
                <p className="text-muted w-lg-75 mt-3 mx-auto">Choose a new password for your account.</p>
              </div>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <div className="d-grid">
                  <Button type="submit" className="btn btn-primary fw-semibold py-2" disabled={loading || !canSubmit}>
                    {loading ? (
                      <>
