    ...
    <div className="auth-box overflow-hidden align-items-center d-flex" style={{ minHeight: '100vh' }}>
      <Container>
        <Row className="justify-content-center">
          <Col xxl={4} md={6} sm={8}>
            <Card className="p-4 w-100 d-flex flex-column justify-content-start align-items-start">
              ...
              <div className="auth-brand text-center mb-4 d-flex flex-wrap">
                <AppLogo logoDarkClassName="d-flex flex-wrap text-start" />
                {pwdFlow.step !== 'pick_second' ? (
              ...
              {!publicAuthLoading && showPickSecond && (
                <div>
                  ...
                  <div className="d-flex flex-column gap-0 mb-3" style={{ height: 420 }}>
                    {showEmailSecondStep ? (
                      <Card
              ...
              <p className="text-muted text-center mt-0 mb-0 w-100">
                New here?{' '}
